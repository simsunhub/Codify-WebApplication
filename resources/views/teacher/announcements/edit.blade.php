...
@section('title', __('messages.dash.edit_announcement'))
...
<div class="row justify-content-center">
    <div class="col-md-8">
        ...
        <div class="d-flex align-items-center gap-3 mb-4">
            ...
            <div>
                <h1 class="ed-page-title mb-0">
                    <i class="fa-solid fa-pencil me-2" style="color:var(--brand)"></i>
                    {{ __('messages.dash.edit_announcement') }}
                </h1>
                <p class="ed-page-sub mb-0">{{ $announcement->title }}</p>
            </div>
        </div>
        ...
        <div class="ed-form-card">
            <form action="{{ route('teacher.announcements.update', $announcement) }}" method="POST">
                @csrf @method('PUT')
                ...
                <div class="mb-5">
                    ...
                    <textarea name="content"
                              ...
                              rows="7">{{ old('content', $announcement->content) }}</textarea>
