                ...
                <form action="{{ route('admin.announcements.update', $announcement) }}" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="target_role" class="form-select @error('target_role') is-invalid @enderror">
                            ...
                            <option value="student_only" {{ old('target_role', $announcement->target_role) == 'student_only' ? 'selected' : '' }}>
                                🎓 {{ __('messages.announcements.target_students') }}
                            </option>
                            <option value="teacher_only" {{ old('target_role', $announcement->target_role) == 'teacher_only' ? 'selected' : '' }}>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>{{ __('messages.dash.update') }}
                        </button>
